-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'USER', 'VENDOR', 'CUSTOMER');
...
-- AddForeignKey
ALTER TABLE "flashSales" ADD CONSTRAINT "flashSales_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
