...
const getAllVendorsFromDB = (params, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } = paginationHelper_1.paginationHelper.calculatePagination(options);
    const { searchTerm } = params, filterData = __rest(params, ["searchTerm"]);
    const andConditions = [];
    if (params.searchTerm) {
        andConditions.push({
            OR: vendor_constant_1.VendorSearchableFields.map((field) => ({
                [field]: {
...
const deleteVendorFromDB = (vendorId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (vendor.user.role !== client_1.Role.VENDOR) {
        throw new Error("You cannot delete a non-vendor user");
    }
    const result = yield prisma_1.default.vendor.delete({ where: { id: vendorId } });
    return result;
});
// Update a Vendor in the database
const updateVendor = (vendorId, payload) => __awaiter(void 0, void 0, void 0, function* () {
