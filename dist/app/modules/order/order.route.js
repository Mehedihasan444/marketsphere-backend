...
router.post("/", (0, auth_1.default)(client_1.Role.CUSTOMER), (0, validateRequest_1.default)(order_validation_1.orderValidationSchema.createOrderValidationSchema), order_controller_1.OrderControllers.createOrder);
// Route to get all orders (only accessible by Admins)
router.get("/", (0, auth_1.default)(client_1.Role.ADMIN), order_controller_1.OrderControllers.getAllOrders);
// Route to update an order (only accessible by Admins)
router.put("/:id", (0, auth_1.default)(client_1.Role.ADMIN), (0, validateRequest_1.default)(order_validation_1.orderValidationSchema.updateOrderValidationSchema), order_controller_1.OrderControllers.updateOrder);
