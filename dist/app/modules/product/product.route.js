...
router.post("/", (0, auth_1.default)(client_1.Role.VENDOR, client_1.Role.ADMIN), (0, validateRequest_1.default)(product_validation_1.productValidationSchema.createProductValidationSchema), product_controller_1.ProductControllers.createProduct);
