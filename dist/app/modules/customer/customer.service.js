...
const getAllCustomersFromDB = (params, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleCustomerFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const customer = yield prisma_1.default.customer.findUniqueOrThrow({ where: { id }, include: { user: true } });
    return customer;
});
//  Delete a customer from the database
const deleteCustomerFromDB = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    const customer = yield prisma_1.default.customer.findUniqueOrThrow({ where: { id: customerId }, include: { user: true } });
    if (customer.user.role !== client_1.Role.ADMIN) {
        throw new Error("You cannot delete an customer user");
    }
    const result = yield prisma_1.default.customer.delete({ where: { id: customerId } });
    return result;
});
