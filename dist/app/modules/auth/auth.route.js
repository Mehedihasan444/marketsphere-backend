...
router.post("/reset-password", (0, auth_1.default)(user_constant_1.USER_ROLE.CUSTOMER, user_constant_1.USER_ROLE.ADMIN, user_constant_1.USER_ROLE.VENDOR), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.resetPasswordValidationSchema), auth_controller_1.AuthControllers.resetPassword);
router.post("/change-password", (0, auth_1.default)(user_constant_1.USER_ROLE.ADMIN, user_constant_1.USER_ROLE.CUSTOMER, user_constant_1.USER_ROLE.VENDOR), auth_controller_1.AuthControllers.changePassword);
